...
exports.writeFileBySlug = function(slug, base, ext, cfg, contents, callback) {
...
exports.fetchFileByPath = function(path, cfg, callback) {
...
exports.removeFileBySlug = function(slug, base, ext, cfg, callback) {
	var projectPath = cfg.appPublic, filePart, filePath;
	slug = nodeSlug(slug);
	filePart = (slug[0] == nodePath.sep) ? slug : nodePath.sep + slug;
...
// Given a section object we need to remove items not in the metaData
// exports.reduceSections	= function(sections, cfg, callback) {
// 	console.log("Before", sections)
// 	for (var section in sections) {
// 		console.log(section)
// 		fetchMetaDataBySection(section, cfg, function(data) {
// 			console.log(data)
// 		});
// 	}
// 	callback()
...
exports.updateMetaData = function(slug, base, cfg, data, callback) {
	var key, contents;
	slug = nodeSlug(slug);

	fetchDataJSONPath(slug, base, cfg, function(err, path) {
		if (err) {
			callback(err, null);
		} else {
			...
			if (contents[key]) {
				contents[key] = extend(contents[key], data);	
			} else {
				contents[key] = data;
			}
...
exports.removeMetaData = function(slug, base, cfg, callback) {
	slug = nodeSlug(slug);
...
exports.getMetaData = function(slug, base, cfg, callback) {
	var key, contents;
...
exports.fetchDataJSONPath = fetchDataJSONPath = function(slug, base, cfg, callback) {
